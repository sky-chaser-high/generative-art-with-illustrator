...
function main() {
    ...
    // draw ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    createRect(aw, 0, 0, 200, 100, setRGBColor(0, 100, 255));
 ...
 * @param {number} c The cyan color value.
 * @param {number} [m] The magenta color value. Optional.
 * @param {number} [y] The yellow color value. Optional.
 * @param {number} [k] The black color value. Optional.
