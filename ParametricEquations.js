...
function main() {
    ...
    var title = 'Parametric Equations';
    var aw = 'Artwork';
    var bg = 'Background';
    ...
    for (var j = 0; j < count; j++) {
        ...
        var frame = 60;
        var lines = 100;
        var x = map(Math.random(), 0, 1, 0, artboard.width);
        var y = map(Math.random(), 0, 1, 0, artboard.height);
        var t = artboard.width * artboard.height * Math.random();
        ...
        for (var i = 0; i < lines; i++) {
            ...
            createLine(aw, [[lx1, ly1], [lx2, ly2]], color);
        }
    }
...
/**
 * function to change initial x coordinate of the line
 * @param {number} t
 * @returns {number}
 */
function x1(t) {
...
/**
 * function to change initial y coordinate of the line
 * @param {number} t
 * @returns {number}
 */
function y1(t) {
...
/**
 * function to change final x coordinate of the line
 * @param {number} t
 * @returns {number}
 */
function x2(t) {
...
/**
 * function to change final y coordinate of the line
 * @param {number} t
 * @returns {number}
 */
function y2(t) {
